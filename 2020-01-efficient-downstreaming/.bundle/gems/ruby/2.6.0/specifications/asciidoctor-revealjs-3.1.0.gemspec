# -*- encoding: utf-8 -*-
# stub: asciidoctor-revealjs 3.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<asciidoctor-doctest>.freeze, ["= 2.0.0.beta.5"])
      s.add_development_dependency(%q<pry>.freeze, ["~> 0.10.4"])
      s.add_development_dependency(%q<pry-byebug>.freeze, [">= 0"])
      s.add_development_dependency(%q<pygments.rb>.freeze, [">= 0"])
      s.add_development_dependency(%q<colorize>.freeze, [">= 0"])
      s.add_development_dependency(%q<asciidoctor-templates-compiler>.freeze, ["~> 0.4.2"])
      ...
      s.add_dependency(%q<asciidoctor-doctest>.freeze, ["= 2.0.0.beta.5"])
      s.add_dependency(%q<pry>.freeze, ["~> 0.10.4"])
      s.add_dependency(%q<pry-byebug>.freeze, [">= 0"])
      s.add_dependency(%q<pygments.rb>.freeze, [">= 0"])
      s.add_dependency(%q<colorize>.freeze, [">= 0"])
      s.add_dependency(%q<asciidoctor-templates-compiler>.freeze, ["~> 0.4.2"])
